// Wait for the DOM element to finish loading before running the game
...
function checkAnswer() { 
    ...
    let userAnswer = parse.Int(document.getElementById("answer-box").value);
